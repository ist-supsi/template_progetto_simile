    ...
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-8">
                    <div v-for="ii in Array.from(Array(Object.entries(cards).length), (n,i)=>i).filter(e=>!(e%2))"  :key="ii[0]" class="row">
                          ...
                          <l-control position="bottomright">
                            <div class="input-group input-group-sm mb-3">
                              ...
                              <select class="custom-select" id="inputGroupSelect03"
                                  ...
                                  >
                                <option v-for="feature in features.features" :value="feature.properties.markerIndex" :key="feature.properties.foi_name">
            ...
            <div class="tab-content" id="myTabContent">
                        ...
                        <div v-if="!(tableData.meta && tableData.meta.total && tableData.meta.total>0)">
                            ...
                            <div v-if="features.features" class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        title="Scegli una località o un'area da analizzare"
                                        >
                                        <option v-for="feature in features.features.filter(feat=>feat.properties.names.some(nfo=>!(nfo.procedure.includes('CIPAIS')||nfo.procedure.startsWith('SATELLITE'))))" :value="feature.properties.markerIndex" :key="feature.properties.foi_name">
                                            {{ guessLocLabel(feature.properties.foi_name) }}
                                        </option>
                                        </select>
                                    </div>
                    ...
                    <div :class="{'tab-pane': true, 'fade': true, show: selectedTab=='cipais', active: selectedTab=='cipais'}"
                            ...
                            <div class="row">
                                ...
                                <div v-if="features.features" class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        title="Scegli una località o un'area da analizzare"
                                        >
                                        <option v-for="feature in features.features.filter(feat=>feat.properties.names.some(nfo=>nfo.procedure.includes('CIPAIS')))" :value="feature.properties.markerIndex"  :key="feature.properties.foi_name">
                                            {{ guessLocLabel(feature.properties.foi_name) }}
                                        </option>
                                        </select>
                                    </div>
                        ...
                        <div v-else class="container-fluid">
                            ...
                            <p class="description text-justify">I dati degli “Indicatori CIPAIS” provengono dalle campagne limnologiche svolte sui laghi Maggiore e
                                ...
                                <div v-for="cc in loopOnPairs(Array.from(Array(dataCipais.length), (n,i)=>i))" class="row"  :key="cc[0]">
                    ...
                    <div :class="{'tab-pane': true, 'fade': true, show: selectedTab=='satellitari', active: selectedTab=='satellitari'}"
                        ...
                        <div v-if="dataSatellite.length>0" class="container-fluid">
                            ...
                            <div v-for="cc in loopOnPairs(Array.from(Array(dataSatellite.length), (n,i)=>i))" class="row"  :key="cc[0]">
                        ...
                        <div v-else>
                            ...
                            <div v-if="features.features" class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        title="Scegli una località o un'area da analizzare"
                                        >
                                        <option v-for="feature in features.features.filter(feat=>feat.properties.names.some(nfo=>nfo.procedure.startsWith('SATELLITE')))" :value="feature.properties.markerIndex"  :key="feature.properties.foi_name">
                                            {{ guessLocLabel(feature.properties.foi_name) }}
                                        </option>
                                        </select>
                                    </div>
